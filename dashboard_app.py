...
6. 한 발언은 정확히 2문장(120자 내외), 역할 분담은 고정이다 — 첫 문장 = 핵심 의견·제안, 둘째 문장 = 반드시 그 의견의 '이유'(데이터·수치·사례·인과).
   둘째 문장이 또 다른 의견·주장이면 규칙 위반이다. "~이기 때문입니다", "~라는 점에서입니다"처럼 근거임이 드러나는 형태로 쓴다.
...
EXPERT_VOICE = {
    ...
    "지정학": ("onyx",    "매우 낮고 무거운 저음의 남성. 안보 브리핑의 긴장감, 속도는 느긋하게 눌러서, 문장 끝을 낮게 떨어뜨리며."),
    "정책":   ("sage",    "차분하고 신중한 중성 톤의 정책가. 보통 속도로 또박또박, 감정 기복 없이 담백하게."),
}
TTS_COMMON = ("실제 한국어 정책 토론회에서 열띤 공방 중인 패널처럼 말하세요. "
              "속도·음높이·무게감은 아래 화자 특성을 최우선으로 따르되, 발음은 뭉개지 않게. "
